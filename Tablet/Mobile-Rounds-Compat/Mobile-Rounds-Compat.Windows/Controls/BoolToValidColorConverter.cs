...
namespace Mobile_Rounds.Controls
{
    ...
    /// </summary>
    public class BoolToValidColorConverter : IValueConverter
    {
        /// <inheritdoc/>
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            ...
            return boolVal ? new SolidColorBrush(Colors.Black) : new SolidColorBrush(Colors.Red);
        }
        ...
        public object ConvertBack(object value, Type targetType, object parameter, string language)
        {
            ...
            return val.Color == Colors.Red ? false : true;
        }
    }
}
